...
#define ELANSPI_UDEV_TYPES FP_DEVICE_UDEV_SUBTYPE_SPIDEV | FP_DEVICE_UDEV_SUBTYPE_HIDRAW
...
#define ELANSPI_MIN_EMPTY_INVALID_PERCENT 20
#define ELANSPI_MAX_REAL_INVALID_PERCENT  5

#define ELANSPI_MIN_REAL_STDDEV 500*500
#define ELANSPI_MAX_EMPTY_STDDEV 200*200

#define ELANSPI_MIN_FRAMES_DEBOUNCE 3

#define ELANSPI_SWIPE_FRAMES_DISCARD 2
#define ELANSPI_MIN_FRAMES_SWIPE (5+ELANSPI_SWIPE_FRAMES_DISCARD)
#define ELANSPI_MAX_FRAMES_SWIPE (20+ELANSPI_SWIPE_FRAMES_DISCARD)

#define ELANSPI_MAX_FRAME_HEIGHT 43
#define ELANSPI_MIN_FRAME_TO_FRAME_DIFF 3000
